...
public class DictionaryTest extends AndroidTestCase {
    ...
    public void testLoadAndClear() throws Exception {
        ...
        dictionary.load(new String[] {"test.json"}, new ProgressBar(getContext()), 0);
        dictionary.setOnDictionaryLoadedListener(new Dictionary.OnDictionaryLoadedListener() {
            @Override
            public void onDictionaryLoaded() {
                latch.countDown();
    ...
    public void testOverrideEntries() throws Exception{
        ...
        dictionary.load((new String[] {"test2.json"}), new ProgressBar(getContext()), 0);
        dictionary.setOnDictionaryLoadedListener(new Dictionary.OnDictionaryLoadedListener() {
            @Override
            public void onDictionaryLoaded() {
                latch1.countDown();
    ...
    public void testLoad2Dictionaries() throws Exception{
        ...
        int size = dictionary.size();
        assertTrue(size > 0);
        dictionary.load(new String[] {"test3.json"}, new ProgressBar(getContext()), 0);
        dictionary.setOnDictionaryLoadedListener(new Dictionary.OnDictionaryLoadedListener() {
            @Override
            public void onDictionaryLoaded() {
                latch1.countDown();
