 ...
 * Handles Plover dictionary formatting
 */
public class FullTranslator extends Translator {
    ...
    public FullTranslator(Context context, boolean useWordList) { //for testing
        mFormatter = new Formatter();
